...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 31 Agu 2019 pada 17.17
...
SELECT nama.id, nama.name, work.name as work, kategori.salary FROM ((nama INNER JOIN work ON work.id=nama.id_work) INNER JOIN kategori ON kategori.id=nama.id_salary);